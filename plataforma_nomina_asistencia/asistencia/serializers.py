"""Compatibilidad para el módulo público de asistencia."""
...
class MarcajeSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = [
			...
			"fecha", "entrada", "salida", "horas_trabajadas", "registrado_por",
			"corregido_por", "motivo_correccion", "creado_en", "actualizado_en",
		]
		read_only_fields = [
			"empleado", "sucursal", "registrado_por", "corregido_por",
			"creado_en", "actualizado_en", "horas_trabajadas",
		]
