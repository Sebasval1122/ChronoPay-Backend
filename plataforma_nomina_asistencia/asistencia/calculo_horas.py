"""Cálculo de horas ordinarias, extra, diurnas/nocturnas y dominicales/festivas
a partir de los marcajes de asistencia (``asistencia.models.Marcaje``) y la
regla laboral vigente (``reglas_laborales.models.ReglaLaboral``).
...
progresiva (ver comentarios en ``reglas_laborales/regla_laboral.py``).
"""
